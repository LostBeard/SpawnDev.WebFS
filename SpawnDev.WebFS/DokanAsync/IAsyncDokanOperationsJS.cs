...
{
    public interface IAsyncDokanOperationsJS : IAsyncDokanOperationsBase
    {
        //
        // Summary:
        ...
        Task<Uint8Array?> ReadFile(string filename, long offset, long maxCount, AsyncDokanFileInfo info);
        ...
        // Returns:
        //     DokanNet.NtStatus or DokanNet.DokanAsyncResult appropriate to the request result.
        Task<WriteFileResult> WriteFile(string filename, Uint8Array buffer, long offset, AsyncDokanFileInfo info);
    }
}
