...
{
    public interface IAsyncDokanOperationsBase
    {
        //
        // Summary:
        ...
        Task<CreateFileResult> CreateFile(string filename, FileAccess access, FileShare share, FileMode mode, System.IO.FileOptions options, FileAttributes attributes, AsyncDokanFileInfo info);
        ...
        // Returns:
        //     DokanNet.NtStatus or DokanNet.DokanAsyncResult appropriate to the request result.
        Task<DokanAsyncResult> SetFileSecurity(string filename, FileSystemSecurityClass security, AccessControlSections sections, AsyncDokanFileInfo info);
