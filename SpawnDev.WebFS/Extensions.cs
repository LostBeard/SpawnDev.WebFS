...
namespace SpawnDev.WebFS
{
    ...
    public static class Extensions
    {
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddWebFSJS<TService, TImplementation>(this IServiceCollection services)
            where TService : class
            where TImplementation : class, TService, IAsyncDokanOperationsJS
        {
            services.AddBlazorJSRuntime();
            ...
            // Register WebFSProvider as IAsyncDokanOperations also so WebFSClient can use it
            services.TryAddSingleton(sp => (IAsyncDokanOperationsJS)sp.GetRequiredService<TService>());
            return services;
        }
        /// <summary>
        /// Registers WebFSClient, TService as IAsyncDokanOperations and TService.
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddWebFSJS<TService>(this IServiceCollection services)
            where TService : class, IAsyncDokanOperationsJS
        {
